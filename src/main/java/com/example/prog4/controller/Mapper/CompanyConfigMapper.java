...
public class CompanyConfigMapper {
  ...
  public CompanyConf toDomain(CompanyConfInput companyConfInput, MultipartFile imageFile)
    ...
    if (companyConfInput.getCompanyDescription() == null ||
        companyConfInput.getCompanyDescription().isEmpty()) {
      companyConfInput.setCompanyDescription(companyConfActual.getCompanyDescription());
    }
    if (companyConfInput.getCompanyPhone() == null ||
        companyConfInput.getCompanyPhone().isEmpty()) {
      companyConfInput.setCompanyPhone(companyConfActual.getCompanyPhone());
    }
    if (companyConfInput.getCompanySlogan() == null ||
        companyConfInput.getCompanySlogan().isEmpty()) {
    ...
    if (companyConfInput.getCompanyEmail() == null ||
        companyConfInput.getCompanyEmail().isEmpty()) {
      companyConfInput.setCompanyEmail(companyConfActual.getCompanyEmail());
    }
    if (companyConfInput.getCompanyAddress() == null ||
        companyConfInput.getCompanyAddress().isEmpty()) {
